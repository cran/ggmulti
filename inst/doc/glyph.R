...
## ----glyph_ggplot, message = FALSE, warning = FALSE, eval = FALSE, fig.width = 7, fig.height = 3, fig.align = "center", out.width = "70%"----
#  library(ggmulti)
...
## ----glyph_ggplot_graph, echo = FALSE, message = FALSE,  warning = FALSE, fig.width = 7, fig.height = 4, fig.align = "center", out.width = "70%"----
include_graphics(path_concat(imageDirectory, "map.png"))

## ----download images, message = FALSE, warning = FALSE, eval = FALSE, fig.width = 7, fig.height = 3, fig.align = "center", out.width = "70%"----
#  library(png)
...
## ----image glyph NBA 2020, message = FALSE, warning = FALSE, eval = FALSE, fig.width = 7, fig.height = 3, fig.align = "center", out.width = "70%"----
...
## ----image_glyph, echo = FALSE, message = FALSE,  warning = FALSE, fig.width = 7, fig.height = 4, fig.align = "center", out.width = "70%"----
include_graphics(path_concat(imageDirectory, "image_glyph.png"))

## ----serialaxes glyph, message = FALSE, warning = FALSE, eval = FALSE, fig.width = 7, fig.height = 3, fig.align = "center", out.width = "70%"----
#  ggplot(iris) +
...
## ----serialaxes glyph graph, echo = FALSE, message = FALSE,  warning = FALSE, fig.width = 7, fig.height = 4, fig.align = "center", out.width = "70%"----
